...
const PrivacyPolicy: React.FC = () => {
	return (
		<Container maxWidth="md" sx={{ py: 4 }}>
			...
			<p>
				This privacy policy is applicable to the Screenshot Pro: Capture & Edit
				app (hereinafter referred to as "Application") for mobile devices, which
			...
			<ul>
				...
				<li>
					<a target="_blank" href="https://vungle.com/privacy/" rel="noopener">
						Vungle
					</a>
				</li>
				<li>
			...
			<p>
				...
				the Application, please contact them at golemapps.main@gmail.com and we
				will respond in a reasonable time. Please note that some or all of the
			...
			<p>
				...
				information from children under 13 years of age. In the case the Service
				...
				Service Provider (golemapps.main@gmail.com) so that they will be able to
			...
			<p>
				...
				Provider via email at golemapps.main@gmail.com.
			</p>
		</Container>
	);
};
