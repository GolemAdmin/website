	...
	return (
		<Container maxWidth="md" sx={{ py: 4 }}>
			<div>
				...
				<p>
					These terms and conditions applies to the Recover Deleted Messages app
					(hereby referred to as "Application") for mobile devices that was
					created by GolemApps (hereby referred to as "Service Provider") as an
